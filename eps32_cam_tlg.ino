...
const char* ssid = "CELERITY_VACALARA";
const char* password = "aramateosebas04";

// Use @myidbot to find out the chat ID of an individual or a group
// Also note that you need to click "start" on a bot before it can
// message you
String chatId = "5035206091";

// Initialize Telegram BOT
String BOTtoken = "5804306870:AAHkzEGt15yEWqTRAnHrd8_yDK6WTWhMuCY";
...
void loop(){
  ...
  if(motionDetected){
    bot.sendMessage(chatId, "Alguien entro a tu habitacion", "");
    sendPhotoTelegram();
